...
"[project]/Documents/SALAO_AGENDAMENTO/salao-beleza/app/api/services/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const services = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SALAO_AGENDAMENTO$2f$salao$2d$beleza$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServices"])();
    const payload = all ? services : services.filter((s)=>(s.visible ?? true) && s.price > 0);
    return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SALAO_AGENDAMENTO$2f$salao$2d$beleza$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(payload);
}
async function POST(request) {
    try {
        const body = await request.json();
        const { name, price, duration, visible } = body;
        ...
        const created = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SALAO_AGENDAMENTO$2f$salao$2d$beleza$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createService"])({
            name,
            price,
            duration,
            visible: visible ?? false
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SALAO_AGENDAMENTO$2f$salao$2d$beleza$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(created, {
            status: 201
        });
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$SALAO_AGENDAMENTO$2f$salao$2d$beleza$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52a416eb._.js.map